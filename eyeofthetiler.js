...
var eyeofthetiler = function (tiles_image, width_per_tile, height_per_tile) {
	...
	that.drawTileImage = function(dest_context, tile_id, dest_x, dest_y, dest_width, dest_height) {
		...
		dest_context.globalCompositeOperation = "source-in";
		dest_context.fillStyle = "rgb(255,0,0)";
		dest_context.fillRect(dest_x, dest_y, dest_width, dest_height);
		dest_context.fill();
